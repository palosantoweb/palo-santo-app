    ...
    <>
      <div className='min-h-screen w-full flex flex-col items-center mb-6'>
        <h1 className='md:px-8  py-2 text-2xl text-[#CC8942] md:text-6xl text-center italic font-bold mb-4'>
          Nuestro rincón de ensueño en la majestuosa Patagonia
        </h1>
      ...
      <div className=' px-10  md:text-2xl flex items-center justify-between text-justify flex-col md:flex-row text-gray-500 mb-6'>
        <div className='flex-1 '>
          <p className='md:mr-6 md:ml-16 mb-6'>
            Imagina despertar cada mañana rodeado de imponentes bosques, con el
            sonido suave de los lagos y el aire fresco de la montaña acariciando
            tu rostro. Este es nuestro sueño hecho realidad, y ahora queremos
        ...
        <div className=' px-10 md:text-2xl flex items-center justify-between text-justify flex-col md:flex-row text-gray-500 mb-6'>
          <div className='flex-1 '>
            <p className='md:mr-6 md:ml-16 mb-6'>
              ...
              naturales? ¿O prefieres explorar en mountain bike los senderos que
              se entrelazan entre los árboles? Tal vez el kayak sea tu forma de
              disfrutar los lagos cristalinos, o quizás sueñas con conquistar
              las cumbres más altas en emocionantes sesiones de montañismo. Sea
              cual sea tu pasión, aquí encontrarás el lugar perfecto para
              vivirla.
            </p>
          </div>
          <div className='flex-1'>
        ...
        <div className='w-full flex flex-col items-end md:pl-28'>
          ...
          <div className=' px-10 text-justify md:text-2xl flex items-center justify-between flex-col md:flex-row  text-gray-500 mb-6'>
            ...
            <p className='md:ml-6 mt-3 md:mr-48'>
              ...
              tus aventuras. Queremos que disfrutes al máximo de todas las
              maravillas que la Patagonia tiene para ofrecer. Y lo mejor de
              todo, lo hemos hecho a costos razonables, para que experimentes la
              excelencia sin preocuparte por tu presupuesto.
            </p>
          </div>
          <div className='mt-10 md:text-2xl px-10 text-justify italic font-semibold text-gray-400'>
            <p>
              ...
              Patagonia desde nuestro campo base. Estamos ansiosos por compartir
              contigo la pasión por la naturaleza, los deportes al aire libre y
              la vida en armonía con nuestro entorno. ¡Te esperamos para vivir
              juntos una experiencia inolvidable en este paraíso patagónico que
              ahora es también tuyo!
            </p>
          </div>
