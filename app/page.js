...
export default function Home() {
  return (
    <main className="w-full flex flex-col items-center justify-between p-6">
      ...
      <h1 className='px-8  py-2 sm:text-3xl  text-[#CC8942] md:text-6xl text-center italic font-semibold mb-4'>¡Tu escape perfecto en medio de la belleza natural!</h1>
    ...
    <div className='w-full flex flex-col items-center mb-6'>
    <hr className='border-1 border-gray-300 w-full mr-[80%] mt-10 mb-28'/>
