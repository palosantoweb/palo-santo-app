...
<main className="min-h-screen w-full flex flex-col items-center justify-between p-6">
      <div className='w-full flex flex-col items-center mb-6'>
        <h1 className='md:px-8 py-2 text-2xl text-[#CC8942] md:text-6xl text-center italic font-bold mb-4'>Explora la Naturaleza en Palo Santo Apartments - Tu Refugio Perfecto</h1>
      ...
      <div className='md:px-10 md:text-2xl flex items-center justify-between text-justify flex-col md:flex-row text-gray-500 mb-6'>
        <div className='flex-1 '>
          <p className='md:mr-6 md:ml-16'>
            Descubre la esencia de la aventura en Palo Santo Apartments, un refugio diseñado para amantes de la naturaleza y la emoción al aire libre. Sumérgete en la simplicidad y eficiencia de nuestros servicios, concebidos para ser amigables con el medio ambiente, mientras te rodeas de un oasis verde con características únicas.
          </p>
        </div>
        <div className='flex-1'>
      ...
      <div className='w-full flex flex-col items-end md:ml-12 md:pl-20'>
        ...
        <div className='text-justify md:text-2xl flex items-center justify-between flex-col md:flex-row  text-gray-500 mb-6'>
          ...
          <p className='md:ml-6 mt-3 md:mr-48'>
            Ubicados estratégicamente en un apacible barrio, Palo Santo Apartments se encuentra a la distancia perfecta del centro, el majestuoso cerro Catedral y las relajantes playas. Nos esforzamos por proporcionar todo lo necesario para que encuentres el descanso que mereces y recuperes energías, permitiéndote luego disfrutar plenamente del encanto del lago, el misterioso bosque y la majestuosidad de la montaña.
          </p>
        </div>
      </div>
      <div className='w-full flex flex-col items-center mb-6'>
